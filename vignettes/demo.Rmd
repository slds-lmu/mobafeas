...
```{r}
opt.so <- mobafeasMBO(objective.so, , surrogate, ctrl, show.info = FALSE)
opt.mo <- mobafeasMBO(objective.mo, , surrogate, ctrl, show.info = FALSE)
opt.sc <- mobafeasMBO(objective.sc, , surrogate, ctrl, show.info = FALSE)
opt.joint.mo <- mobafeasMBO(objective.joint.mo, , surrogate.joint, ctrl.joint,
  show.info = FALSE)
```
